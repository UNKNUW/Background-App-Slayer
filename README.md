...
Jika mengalami error saat install, pakai cara yang sama seperti project sebelumnya [klik di sini]([./for_Android_11.md](http://github.com/UNKNUW/SmartAppClose/blob/main/for_Android_11.md))
